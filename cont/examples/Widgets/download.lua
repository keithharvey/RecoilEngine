...
function widget:Initialize()
	Engine.Shared.Log(LOG_SECTION, LOG.NOTICE, "Starting download of " .. archiveType .. " " .. archiveName)
...
function widget:DownloadStarted(id)
	Engine.Shared.Log(LOG_SECTION, LOG.NOTICE, "Download started. ID: " .. id)
end

function widget:DownloadQueued(id)
	Engine.Shared.Log(LOG_SECTION, LOG.NOTICE, "Download queued. ID: " .. id)
end

function widget:DownloadFinished(id)
	Engine.Shared.Log(LOG_SECTION, LOG.NOTICE, "Download finished. ID: " .. id)
end

function widget:DownloadFailed(id, errorid)
	Engine.Shared.Log(LOG_SECTION, LOG.NOTICE, "Download failed. ID: " .. id .. ", error ID: " .. errorid)
end

function widget:DownloadProgress(id, downloaded, total)
	Engine.Shared.Log(LOG_SECTION, LOG.NOTICE, "Download progress. ID: " .. id .. ", progress: " .. downloaded .. "/" .. total)
end
