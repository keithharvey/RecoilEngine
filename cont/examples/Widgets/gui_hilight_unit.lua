...
local spGetFeatureAllyTeam      = SpringShared.GetFeatureAllyTeam
...
local spGetMyAllyTeamID         = SpringUnsynced.GetMyAllyTeamID
local spGetMyPlayerID           = SpringUnsynced.GetMyPlayerID
local spGetMyTeamID             = SpringUnsynced.GetMyTeamID
local spGetPlayerControlledUnit = SpringShared.GetPlayerControlledUnit
