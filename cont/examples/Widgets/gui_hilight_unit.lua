...
local spGetFeatureAllyTeam      = Engine.Shared.GetFeatureAllyTeam
...
local spGetMyAllyTeamID         = Engine.Unsynced.GetMyAllyTeamID
local spGetMyPlayerID           = Engine.Unsynced.GetMyPlayerID
local spGetMyTeamID             = Engine.Unsynced.GetMyTeamID
local spGetPlayerControlledUnit = Engine.Shared.GetPlayerControlledUnit
